...
maximum recursion depth exceeded while calling a Python object, хотя при декорированиивнешней функции при m = 900 программа отрабоатывает нормально. 

Количество элементов: 900, их сумма: 0.6666666666666666
Filename: /home/vlad/geekbrains/python_algos/Урок 6. Практическое задание/task_3.py
